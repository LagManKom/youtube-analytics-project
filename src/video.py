...
class Video:
    def __init__(self, video_id: str):
        ...
        try:
            ...
            video = self.__youtube.captions().list(videoId=self.video_id, part='snippet').execute()
            ...
            self.title: str = self.__video_response['items'][0]['snippet']['title']  # название видео
